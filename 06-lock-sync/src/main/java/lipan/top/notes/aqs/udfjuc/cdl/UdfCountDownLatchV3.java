...
import lipan.top.notes.aqs.udfjuc.UdfAQS;
...
public class UdfCountDownLatchV3 {
    ...
    public UdfCountDownLatchV3(int count) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        UdfCountDownLatchV3 cdLdemo = new UdfCountDownLatchV3(10); // 创建，计数数值
        // 启动九个线程，最后一个两秒后启动
        for (int i = 0; i < 10; i++) {
            int finalI = i;
            new Thread(() -> {
